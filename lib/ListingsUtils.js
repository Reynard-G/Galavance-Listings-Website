...
export function sortAndFilter(listings, filters, sortValue) {
  ...
  if (filters.propertyStatus != FilterButtonTabKeys.All)
    filteredListings = filteredListings.filter(listing => FilterButtonTabKeys[listing.status] == filters.propertyStatus);
